...
const file_cotevent_proto_rawDesc = "" +
	"\n" +
	"\x0ecotevent.proto\x1a\fdetail.proto\"\x8d\x03\n" +
	"\bCotEvent\x12\x12\n" +
	...
	"\x02le\x18\x0e \x01(\x01R\x02le\x12\x1f\n" +
	"\x06detail\x18\x0f \x01(\v2\a.DetailR\x06detailB,H\x03Z(github.com/coreywagehoft/go-tak/cotprotob\x06proto3"
