...
const file_takmessage_proto_rawDesc = "" +
	"\n" +
	"\x10takmessage.proto\x1a\x0ecotevent.proto\x1a\x10takcontrol.proto\"\xac\x01\n" +
	"\n" +
	"TakMessage\x12+\n" +
	"\n" +
	"takControl\x18\x01 \x01(\v2\v.TakControlR\n" +
	"takControl\x12%\n" +
	"\bcotEvent\x18\x02 \x01(\v2\t.CotEventR\bcotEvent\x12&\n" +
	"\x0esubmissionTime\x18\x03 \x01(\x04R\x0esubmissionTime\x12\"\n" +
	"\fcreationTime\x18\x04 \x01(\x04R\fcreationTimeB,H\x03Z(github.com/coreywagehoft/go-tak/cotprotob\x06proto3"
