...
const file_detail_proto_rawDesc = "" +
	"\n" +
	"\fdetail.proto\x1a\rcontact.proto\x1a\vgroup.proto\x1a\x17precisionlocation.proto\x1a\fstatus.proto\x1a\n" +
	"takv.proto\x1a\vtrack.proto\"\x84\x02\n" +
	"\x06Detail\x12\x1c\n" +
	"\txmlDetail\x18\x01 \x01(\tR\txmlDetail\x12\"\n" +
	"\acontact\x18\x02 \x01(\v2\b.ContactR\acontact\x12\x1c\n" +
	"\x05group\x18\x03 \x01(\v2\x06.GroupR\x05group\x12@\n" +
	"\x11precisionLocation\x18\x04 \x01(\v2\x12.PrecisionLocationR\x11precisionLocation\x12\x1f\n" +
	"\x06status\x18\x05 \x01(\v2\a.StatusR\x06status\x12\x19\n" +
	"\x04takv\x18\x06 \x01(\v2\x05.TakvR\x04takv\x12\x1c\n" +
	"\x05track\x18\a \x01(\v2\x06.TrackR\x05trackB,H\x03Z(github.com/coreywagehoft/go-tak/cotprotob\x06proto3"
